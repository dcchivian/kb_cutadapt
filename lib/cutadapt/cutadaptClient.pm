package cutadapt::cutadaptClient;
...
sub new
{
    ...
    my $self = {
	client => cutadapt::cutadaptClient::RpcClient->new,
	url => $url,
	headers => [],
    };
...
sub _validate_version {
    ...
    if ($sMinor > $cMinor) {
        warn "New client version available for cutadapt::cutadaptClient\n";
    }
    if ($sMajor == 0) {
        warn "cutadapt::cutadaptClient version is $svr_version. API subject to change.\n";
    }
}
...
package cutadapt::cutadaptClient::RpcClient;
