...
/**
 * <p>Original spec-file module name: kb_cutadapt</p>
 * <pre>
 * A KBase module: cutadapt
 * </pre>
 */
public class KbCutadaptClient {
     ...
     */
    public KbCutadaptClient(URL url) {
     ...
     * validity.
     */
    public KbCutadaptClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public KbCutadaptClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public KbCutadaptClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
     ...
     * @throws JsonClientException if a JSON RPC exception occurs
     */
    public ExecRemoveAdaptersResult execRemoveAdapters(RemoveAdapetersParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        List<Object> args = new ArrayList<Object>();
        args.add(params);
     ...
     * @throws JsonClientException if a JSON RPC exception occurs
     */
    public ExecRemoveAdaptersResult execRemoveAdaptersOneLibrary(RemoveAdapetersParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        List<Object> args = new ArrayList<Object>();
        args.add(params);
        TypeReference<List<ExecRemoveAdaptersResult>> retType = new TypeReference<List<ExecRemoveAdaptersResult>>() {};
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("kb_cutadapt.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
