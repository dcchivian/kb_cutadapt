...
build-test-script:
	...
	echo 'python -m nose --nocapture --with-coverage --cover-package=kb_cutadapt.CutadaptUtil --cover-package=kb_cutadapt.kb_cutadaptImpl --cover-html --cover-html-dir=/kb/module/work/cover_html .' >> $(TEST_DIR)/$(TEST_SCRIPT_NAME)
