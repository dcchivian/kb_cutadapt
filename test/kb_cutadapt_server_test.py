...
class kb_cutadaptTest(unittest.TestCase):
    ...
    # HIDE @unittest.skip("skipped test_basic_options_SE_Lib")
    ...
    #
    # Uncomment to skip this test
    # HIDE @unittest.skip("skipped test_basic_options_PE_Lib")
    ...
    #
    # Uncomment to skip this test
    # HIDE @unittest.skip("skipped test_basic_options_SE_ReadsSet")
    ...
    #
    # Uncomment to skip this test
    # HIDE @unittest.skip("skipped test_basic_options_PE_ReadsSet")
    ...
    #
    # Uncomment to skip this test
    # HIDE @unittest.skip("skipped test_basic_options_PE_Lib_threeprime_anchored")
    ...
    #
    # Uncomment to skip this test
    # HIDE @unittest.skip("skipped test_basic_options_PE_Lib_threeprime_UNanchored")
    ...
    #
    # Uncomment to skip this test
    # HIDE @unittest.skip("skipped test_basic_options_PE_Lib_fiveprime_UNanchored")
    ...
    #
    # Uncomment to skip this test
    # HIDE @unittest.skip("skipped test_discard_untrimmed_option_PE_Lib")
